...
public class MDM_Workstation_Master_QMS extends BasePage {

	public MDM_Workstation_Master_QMS(WebDriver driver) {
		super(driver);
	}
	...
	@FindBy(xpath = "//button[@id='upload-btn-7']")
	WebElement uploadFile;
	
	@FindBy(xpath = "//button[@id='download-template-btn-7']")
