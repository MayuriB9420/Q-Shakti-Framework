...
public class MDM_CustomerMaster_QMS extends BasePage {

	public MDM_CustomerMaster_QMS(WebDriver driver) {
		super(driver);
	}
	...
	@FindBy(xpath = "//button[@id='upload-btn-5']")
	WebElement uploadFile;
	
	@FindBy(xpath = "//button[@id='download-template-btn-5']")
