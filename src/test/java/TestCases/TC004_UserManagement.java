...
public class TC004_UserManagement extends BaseClass {
	...
	public void testCreateUser(String FirstName, String LastName, String Phone, String Email, String EmpId,
		...
		try {
			...
			ExtentReportManager.logInfo("Clicked User Management");
			...
			logger.info("Entered Last Name: " + FirstName);
			...
			/*
			 ...
			 Assert.assertNotNull(toasterMsg2, "Toaster message not displayed!");
			  Assert.assertTrue( toasterMsg2.contains("User created successfully") ||
			  toasterMsg2.contains("created"), "Unexpected toaster message: " + toasterMsg2
			  );
			...
			ExtentReportManager.logInfo(" User Mgt PDF downloaded");
			Thread.sleep(1000);

			userPage.downloadUserMgtExcel();
			logger.info(" User Mgt Excel downloaded");
			ExtentReportManager.logInfo(" User Mgt Excel downloaded");
			Thread.sleep(1000);

			userPage.closeCreateUserForm();
			logger.info("Closed User Management Page");
			ExtentReportManager.logPass("Create User Test passed for: " + FirstName);
			Thread.sleep(1500);
